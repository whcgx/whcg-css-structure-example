...
<html lang="en">
<head>
    <title>Code coverage report for vaadin-radio-button.html</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> vaadin-radio-button.html
    </h1>
    <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.checked &amp;&amp; !this.disabled) {
              this.checked = true;
            }
          });
&nbsp;
          this.addEventListener('keydown', e =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.disabled &amp;&amp; e.keyCode === 32) {
              e.preventDefault();
              this.setAttribute('active', '');
            }
          });
...
&nbsp;
<span class="fstat-no" title="function not covered" >        _p</span>reventDefault(e) {
