...
<html lang="en">
<head>
    <title>Code coverage report for vaadin-radio-group.html</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> vaadin-radio-group.html
    </h1>
    <div class='clearfix'>
...
<a name='L344'></a><a href='#L344'>344</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1748x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
            this._filterRadioButtons(info.removedNodes).forEach(<span class="fstat-no" title="function not covered" >bu</span>tton =&gt; {
<span class="cstat-no" title="statement not covered" >              button.removeEventListener('checked-changed', checkedChangedListener);</span>
            });
&nbsp;
          });
        }
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this._radioButtons.length) {
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.disabled || this.readonly) {
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
            // if e.target is vaadin-radio-group then assign to checkedRadioButton currently checked radio button
            var checkedRadioButton = (e.target == this) ? this._checkedButton : <span class="branch-1 cbranch-no" title="branch not covered" >e.target;</span>
&nbsp;
...
&nbsp;
        _selectButton(element, setFocusRing) {
          if (this._containsFocus()) {
            element.focus();
            <span class="missing-if-branch" title="else path not taken" >E</span>if (setFocusRing) {
...
&nbsp;
        _containsFocus() {
          ...
          const activeElement = root._activeElement !== undefined ? root._activeElement : <span class="branch-1 cbranch-no" title="branch not covered" >root.activeElement;</span>
...
&nbsp;
        _selectNextButton(element) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._hasEnabledButtons()) {
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (newCheckedButton) {
              this._selectButton(newCheckedButton);
            } else {
<span class="cstat-no" title="statement not covered" >              console.warn(`No &lt;vaadin-radio-button&gt; with value ${newV} found.`);</span>
            }
          }
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (newV !== '' &amp;&amp; newV != null) {
            this.setAttribute('has-value', '');
          } else {
<span class="cstat-no" title="statement not covered" >            this.removeAttribute('has-value');</span>
          }
        }
&nbsp;
        /**
...
&nbsp;
       ...
       * @namespace Vaadin
       */
      window.Vaadin = window.Vaadin || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Jun 28 2018 09:07:25 GMT+0200 (CEST)
</div>
</div>
