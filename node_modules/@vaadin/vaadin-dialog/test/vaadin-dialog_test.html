...
<head>
  ...
  <script type="module" src="../vaadin-dialog.js"></script>
</head>
...
describe('vaadin-dialog data binding', () => {
  ...
  it('dialog should bind parent property', () => {
    ...
    expect(overlay.$.content.shadowRoot.querySelector('span').textContent.trim()).to.equal('foo');
  });

  it('dialog should support two-way data binding', () => {
    const input = overlay.$.content.shadowRoot.querySelector('input');
    input.value = 'bar';
