...
import '@whcg/whcg-test-button/theme/whcg-test-button-styles.js';
import '@vaadin/vaadin-button/src/vaadin-button.js';
 
class WhcgTestButton extends PolymerElement {
    static get template() {
        return html `
...
window.customElements.define('whcg-test-button', WhcgTestButton);

export { WhcgTestButton };
