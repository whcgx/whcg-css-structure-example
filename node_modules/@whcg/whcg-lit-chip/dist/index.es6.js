...
import '@whcg/whcg-lit-chip/theme/whcg-lit-chip-styles.js';
import { html, PolymerElement } from '@polymer/polymer/polymer-element.js';

class WhcgLitChip extends PolymerElement {
    static get template() {
        return html `
        <style>
             vaadin-button {
                --whcg-host-font-family: var(--whcg-chip-host-font-family);
                --whcg-host-font-size: var(--whcg-chip-host-font-size);
                --whcg-host-font-weight: var(--whcg-chip-host-font-weight);
...
window.customElements.define('whcg-lit-chip', WhcgLitChip);
