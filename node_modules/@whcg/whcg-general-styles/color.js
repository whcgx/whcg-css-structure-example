...
$_documentContainer.innerHTML = `<custom-style>
  <style>
    html {
      /* Tint */
      --parmaco-tint-5pct: hsla(0, 0%, 100%, 0.3);
      --parmaco-tint-10pct: hsla(0, 0%, 100%, 0.37);
      --parmaco-tint-20pct: hsla(0, 0%, 100%, 0.44);
      --parmaco-tint-30pct: hsla(0, 0%, 100%, 0.5);
      --parmaco-tint-40pct: hsla(0, 0%, 100%, 0.57);
      --parmaco-tint-50pct: hsla(0, 0%, 100%, 0.64);
      --parmaco-tint-60pct: hsla(0, 0%, 100%, 0.7);
      --parmaco-tint-70pct: hsla(0, 0%, 100%, 0.77);
      --parmaco-tint-80pct: hsla(0, 0%, 100%, 0.84);
      --parmaco-tint-90pct: hsla(0, 0%, 100%, 0.9);
      --parmaco-tint-100pct: #FFF;

      /* Shade */
      --parmaco-shade-5pct: hsla(214, 61%, 25%, 0.05);
      --parmaco-shade-10pct: hsla(214, 57%, 24%, 0.1);
      --parmaco-shade-20pct: hsla(214, 53%, 23%, 0.16);
      --parmaco-shade-30pct: hsla(214, 50%, 22%, 0.26);
      --parmaco-shade-40pct: hsla(214, 47%, 21%, 0.38);
      --parmaco-shade-50pct: hsla(214, 45%, 20%, 0.5);
      --parmaco-shade-60pct: hsla(214, 43%, 19%, 0.61);
      --parmaco-shade-70pct: hsla(214, 42%, 18%, 0.72);
      --parmaco-shade-80pct: hsla(214, 41%, 17%, 0.83);
      --parmaco-shade-90pct: hsla(214, 40%, 16%, 0.94);
      --parmaco-shade-100pct: hsl(214, 35%, 15%);
    ...
    :root {
      ...
      /* whcg-text-field */
      --whcg-text-field-label-color: var(--parmaco-tertiary-text-color);
      --whcg-text-field-input-field-text-color: var(--parmaco-tertiary-text-color, green);
      --whcg-text-field-input-field-background-color: var(--parmaco-attention-color-100pct, yellow);

      /*__dark*/
      --whcg-text-field-label-color__dark: var(--parmaco-black-text-color);
      --whcg-text-field-input-field-text-color__dark: var(--parmaco-primary-contrast-color, green);
      --whcg-text-field-input-field-background-color__dark: var(--parmaco-primary-color-100pct, yellow);
    }
