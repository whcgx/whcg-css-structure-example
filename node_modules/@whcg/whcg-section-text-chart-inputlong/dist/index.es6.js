...
class WhcgSectionTextChartInputlong extends PolymerElement {
  static get template() {
    return html`
...
window.customElements.define('whcg-section-text-chart-inputlong', WhcgSectionTextChartInputlong);

export { WhcgSectionTextChartInputlong };
