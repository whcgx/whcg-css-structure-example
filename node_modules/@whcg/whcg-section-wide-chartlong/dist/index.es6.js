...
class WhcgSectionWideChartlong extends PolymerElement {
  static get template() {
    return html`
    ...
    <div class="col1span12 grid-12 categoryinputsection">
        <div class="col2span10 categoryinputsection-content-chart--bottom">
...
window.customElements.define('whcg-section-wide-chartlong', WhcgSectionWideChartlong);

export { WhcgSectionWideChartlong };
