...
import '@whcg/whcg-lit-button/theme/whcg-lit-button-styles.js';
import { html, PolymerElement } from '@polymer/polymer/polymer-element.js';

class WhcgLitButton extends PolymerElement {
    static get template() {
        return html `
        <style>
             vaadin-button {
                --whcg-host-font-family: var(--whcg-button-host-font-family);
                --whcg-host-font-size: var(--whcg-button-host-font-size);
                --whcg-host-font-weight: var(--whcg-button-host-font-weight);
...
window.customElements.define('whcg-lit-button', WhcgLitButton);

export { WhcgLitButton };
