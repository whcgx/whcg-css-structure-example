...
$_documentContainer.innerHTML = `<dom-module id="whcg-lit-text-field-styles" theme-for="vaadin-text-field">
  <template>
    <style>
      ...
      :host(.dark) [part="label"] {
        color: var(--whcg-label-color__dark);
      }

      :host(:hover:not([focused])) [part="label"] {
        color: var(--whcg-host-hover-not-focused-label-color);
      }

      :host([focused]) [part="label"] {
        color: var(--whcg-host-focused-label-color);
      }
      ...
      :host(.dark) [part="input-field"] {
        background-color: var(--whcg-input-field-background-color__dark);
      }
      :host(.shadow) [part="input-field"] {
        box-shadow: var(--whcg-input-field-box-shadow);
      }
      ...
      :host(.dark) [part="value"] {
        color: var(--whcg-value-color__dark);
      }
