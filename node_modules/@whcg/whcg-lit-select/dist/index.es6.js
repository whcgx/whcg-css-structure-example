...
import '@whcg/whcg-lit-list-box';

import '@vaadin/vaadin-list-box/src/vaadin-list-box.js';
import '@vaadin/vaadin-item/src/vaadin-item.js';
import '@whcg/whcg-lit-list-box/theme/whcg-lit-item-styles.js';
import '@whcg/whcg-lit-list-box/theme/whcg-lit-list-box-styles.js';
import '@whcg/whcg-lit-select/theme/whcg-lit-dropdown-styles.js';
import '@vaadin/vaadin-dropdown-menu/src/vaadin-dropdown-menu.js';


import { html, PolymerElement } from '@polymer/polymer/polymer-element.js';

class WhcgLitSelect extends PolymerElement {
    static get template() {
        return html `
        <style>
        ...
        <vaadin-dropdown-menu placeholder="placeholder" label="LABEL"><template><vaadin-list-box><vaadin-item value="1">Item one</vaadin-item><vaadin-item value="2">Item two</vaadin-item><vaadin-item value="3">Item three</vaadin-item><vaadin-item value="4">Item four</vaadin-item></vaadin-list-box></template></vaadin-dropdown-menu>
        <!-- <vaadin-dropdown-menu placeholder="placeholder" label="LABEL"><template><whcg-lit-list-box></whcg-lit-list-box></template></vaadin-dropdown-menu> -->
    `
    };   
}

window.customElements.define('whcg-lit-select', WhcgLitSelect);

export { WhcgLitSelect };
