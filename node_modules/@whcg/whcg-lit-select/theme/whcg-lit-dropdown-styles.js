...
<template>
    ...
    [part\$="button"] {
      ...
      height: 1em;
      line-height: 1;
      font-size: var(--parmaco-icon-size-m);
      text-align: center;
      color: var(--parmaco-black-color-60pct);
      transition: 0.2s color;
      cursor: default;
    }

    :host(:not([readonly])) [part\$="button"]:hover {
      color: var(--parmaco-black-color-90pct);
    }

    :host([disabled]) [part\$="button"],
    :host([readonly]) [part\$="button"] {
      color: var(--parmaco-black-color-20pct);
    }
    ...
    [part\$="button"]::before {
      ...
      :host(:hover:not([readonly]):not([disabled])) [part="toggle-button"] {
        color: var(--parmaco-black-color-80pct);
      }
    </style>
  </template>
  ...
  <template>
    ...
    [part="overlay"] {
      ...
      background-image: linear-gradient(var(--whcg-tint-5pct), var(--whcg-tint-5pct));
