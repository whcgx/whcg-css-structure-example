...
class WhcgApp extends PolymerElement {
 ...
 -->
	...
	<style include = "style-element-grid">
        ...
        .selectandexplainwrapperbig {
            padding-top: 130px;
        }

        .selectandexplainheadlinebig {
            padding-top: 32px;
            font-family: var(--parmaco-font-family);
    ...
    <div class="wrapper">
        ...
        <div class="grid-12 container">
            ...
            <div class="col1span12 grid-12 main">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">KALKYLLÄNGD</div>
                    <div class="col4span8 grid-8">
                        
                        <whcg-number-field-box column name="" mode="none" class="col1span2">
                        ...
                        <div class="col4span5 selectexplain">
                            Pellentesque sit amet nisl odio. Duis erat libero, placerat vitae mi at, bibendum porta nisi. Proin fermentum mi et nibh sollicitudin, in interdum mauris molestie. Aliquam fermentum dolor pulvinar tempus blandit. Cras aliquam lectus ut dolor ornare aliquam. Curabitur lobortis ut nibh in sollicitudin. In viverra facilisis magna, a tempus lorem dictum at. Ut porta vehicula lacus, nec mollis libero rutrum id. Aliquam quis tristique risus.
                        </div>
                    </div>
                </div>
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">INFLATION</div>
                    <div class="col4span8 grid-8">
                        <whcg-number-field-box name="Inflation" mode="none" class="col1span2">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">KALKYLRÄNTA</div>
                    <div class="col4span8 grid-8">
                        <whcg-number-field-box name="Kalkylränta" mode="none" class="col1span2">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">INITIAL YTSTORLEK</div>
                    <div class="col4span8 grid-8">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">HYRESNIVÅ OCH HYRESUTVECKLING</div>
                    <div class="col4span8 grid-8">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">VÄRMEKOSTNAD</div>
                    <div class="col4span8 grid-8">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 selectandexplainwrapperbig">
                    <div class="col2span2 selectandexplainheadlinebig">KOSTNADER FÖR UPPFÖRANDE OCH AVVECKLING</div>
                        <div class="col4span8 grid-8">
...
<!--
      ...
      -->
            ...
            <div class="grid-12 footer">
                ...
                <div class="col9span3 grid-3 newsletter">
                    ...
                    <div class="col1span3 grid-3 newslettersub">
                        <whcg-search-box class="col1span3 newslettersearchbox">
                        </whcg-search-box>
                    </div>
                </div>
            </div>
