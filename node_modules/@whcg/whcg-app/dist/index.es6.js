        ...
        <div class="grid-12 container">
            ...
            <div class="col1span12 grid-12 main">
                <div class="col2span2 grid-2 sidemenu">
                    <whcg-lit-tab></whcg-lit-tab>
                </div>
                
                <div class="col4span8 grid-8 headlineandingress">
                    
                    <div class="col1span8 headline">
                        KALKYLDATA
                    </div>
                    <div class="col1span8 ingress">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">KALKYLLÄNGD</div>
                    <div class="col4span8 grid-8 categoryinputsection-content">
                        ...
                        <div class="col6span3 gridcontent-right categoryinputsection-content-inputbox">
                            <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">INFLATION</div>
                    <div class="col4span8 grid-8 categoryinputsection-content">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">KALKYLRÄNTA</div>
                    <div class="col4span8 grid-8 categoryinputsection-content--withchartbottom">
                        ...
                        <div class="col4span5 categoryinputsection-content-chart--bottom">
                            <whcg-chart type="bar" legendposition="right" width="800px" height="300px" legendfontsize="10" legendfontfamily="Helvetica" chartjson="{{chartJsSumAreasJson}}">
                            </whcg-chart> 
                        </div>
                    </div>
                </div>
                <div class="col1span12 grid-12 categoryinputsection">
                    ...
                    <div class="col4span8 grid-8 categoryinputsection-content--withchartbottom">
                        ...
                        <div class="col1span5 categoryinputsection-content-chart--bottom">
                            <whcg-chart type="bar" width="800px" height="300px" legendposition="right" legendfontsize="10" legendfontfamily="Helvetica" chartjson="{{chartJsSumAreasJson}}">
                            </whcg-chart> 
                        </div>
                        <div class="col6span3 gridcontent-right">
                            <whcg-number-field-box name="Kalkylränta" mode="none" class="categoryinputsection-content-inputbox">
                                <whcg-select label="Kalkylränta" suffix="%" value="0.07" placeholder="...antal procent" valueoutput="{{discountrate}}" jsoninput='[{"value": 0.01, "caption": "1"}, {"value": 0.02, "caption": "2"}, {"value": 0.03, "caption": "2"}, {"value": 0.04, "caption": "4"}, {"value": 0.05, "caption": "5"}, {"value": 0.06, "caption": "6"}, {"value": 0.07, "caption": "7"}, {"value": 0.08, "caption": "8"}, {"value": 0.09, "caption": "9"}, {"value": 0.10, "caption": "10"}]'></whcg-select>
                            </whcg-number-field-box> 
                        </div>
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    ...
                    <div class="col4span8 grid-8 categoryinputsection-content--withcharttop">
                        <div class="col1span3 categoryinputsection-content-text--top">
                            Pellentesque sit amet nisl odio. Duis erat libero, placerat vitae mi at, bibendum porta nisi. Proin fermentum mi et nibh sollicitudin, in interdum mauris molestie. Aliquam fermentum dolor pulvinar tempus blandit. Cras aliquam lectus ut dolor ornare aliquam. Curabitur lobortis ut nibh in sollicitudin. In viverra facilisis magna, a tempus lorem dictum at. Ut porta vehicula lacus, nec mollis libero rutrum id. Aliquam quis tristique risus.
                        </div>
                        <div class="col4span5 categoryinputsection-content-chart--top">
                            <whcg-chart type="bar" width="800px" height="300px" legendposition="right" legendfontsize="10" legendfontfamily="Helvetica" chartjson="{{chartJsSumAreasJson}}">
                            </whcg-chart> 
                        </div>
                ...
                <div class="col4span8 grid-8 mainrightpaddingtop">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">INITIAL YTSTORLEK</div>
                    <div class="col4span8 grid-8 categoryinputsection-content">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">HYRESNIVÅ OCH HYRESUTVECKLING</div>
                    <div class="col4span8 grid-8 categoryinputsection-content">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">VÄRMEKOSTNAD</div>
                    <div class="col4span8 grid-8 categoryinputsection-content">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="col1span12 grid-12 categoryinputsection">
                    <div class="col2span2 categoryinputsection-headline">KOSTNADER FÖR UPPFÖRANDE OCH AVVECKLING</div>
                        <div class="col4span8 grid-8 categoryinputsection-content">
            ...
            <div class="col1span12 grid-12 rent-expansion-wrapper">
                <whcg-box-container class="col4span8" name="Expansionsfaser">
...
<!--
      ...
      -->
            ...
            <div class="col1span12 grid-12 rent-detraction-wrapper">
                <whcg-box-container class="col4span8" name="Avvecklingsfaser">
...
<!--
      ...
      -->
            ...
            <div class="grid-12 footer">
                <div class="col2span4 grid-4 about">
                    <div class="col1span1 aboutheadline">
                        OM MODELLEN
                    </div>
                    <div class="col1span4 aboutexplain">
                ...
                <div class="col7span2 grid-2">
                    <div class="col1span1 contactheadline">
                        KONTAKTA OSS
                    </div>

                    <div class="col1span2 contactsub">
                        <div class="contactsubhedline">
                            Information
                        </div>
                        <div class="contactsubexplain">
                            08-783 24 12
                            info@parmaco.se
                        </div>
                    </div>
                ...
                <div class="col9span3 grid-3 gridcontent-right">
                    <div class="col1span3 newsletterheadline">
                            TA DEL AV VÅRAT NYHETSBREV
                    </div>

                    <div class="col1span3 grid-3 newslettersub">
                        <div class="col1span3 newslettersubhedline">
                            Information
                        </div>
                        <div class="col1span3 newslettersubexplain">
                            Få den senaste informationen om utvecklingen på marknaden för hyrda skollokaler
                        </div>
                    </div>

                    <div class="col1span3 grid-3 newslettersub">
                        <whcg-search-box class="col1span3 gridcontent-right">
                        </whcg-search-box>
                    </div>
                </div>
            </div>
