  ...
  <div class="wrapper">
        ...
        <div class="container">
            ...
            <div class="main">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">KALKYLLÄNGD</div>
                    <div class="selectandexplainbig">
                        
                        <whcg-number-field-box column name="" mode="none" class="select">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">INFLATION</div>
                    <div class="selectandexplainbig">
                        <whcg-number-field-box name="Inflation" mode="none" class="select">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">KALKYLRÄNTA</div>
                    <div class="selectandexplainbig">
                        <whcg-number-field-box name="Kalkylränta" mode="none" class="select">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">INITIAL YTSTORLEK</div>
                    <div class="selectandexplainbig">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">HYRESNIVÅ OCH HYRESUTVECKLING</div>
                    <div class="selectandexplainbig">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">VÄRMEKOSTNAD</div>
                    <div class="selectandexplainbig">
                        <whcg-number-field-box column name="" mode="none">
                ...
                <div class="selectandexplainwrapperbig">
                    <div class="selectandexplainheadlinebig">KOSTNADER FÖR UPPFÖRANDE OCH AVVECKLING</div>
                        <div class="selectandexplainbig">
            ...
            <div class="rent-expansion-wrapper">
                <whcg-box-container class="rent-expansion" name="Expansionsfaser">
...
<!--
      ...
      -->
            ...
            <div class="rent-detraction-wrapper">
                <whcg-box-container class="rent-detraction" name="Avvecklingsfaser">
...
<!--
      ...
      -->
                ...
                <whcg-chart class="chart-box" type="bar" width="800px" height="300px" legendposition="right" legendfontsize="10" legendfontfamily="Helvetica"
            ...
            <div class="footer">
                ...
                <div class="newsletter">
                    ...
                    <div class="newslettersub">
                        <div class="newslettersubhedline">
                            Information
                        </div>
                        <div class="newslettersubexplain">
                            Få den senaste informationen om utvecklingen på marknaden för hyrda skollokaler
                        </div>
                    </div>

                    <div class="newslettersub">
                        <whcg-search-box class="newslettersearchbox">
                        </whcg-search-box>
                    </div>
                </div>
            </div>
