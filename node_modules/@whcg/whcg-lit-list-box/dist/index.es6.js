...
class WhcgLitListBox extends PolymerElement {
    static get template() {
        return html `
        <style>
             vaadin-list-box {
        ...
        <vaadin-list-box><vaadin-item>Item one</vaadin-item><vaadin-item disabled>Item two</vaadin-item><vaadin-item>Item three</vaadin-item></vaadin-list-box>
    `
    };   
}

window.customElements.define('whcg-lit-list-box', WhcgLitListBox);

export { WhcgLitListBox };
